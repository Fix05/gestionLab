...
export default function Aside() {
    ...
    return (
        <Asside id="logo-sidebar" className={`fixed bg-gray-700 shadow-2xl top-10 z-10 w-52 h-screen ${openElement ? "pt-6" : "pt-20"} transition-transform -translate-x-full bg-white  sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700`} aria-label="Sidebar">
            <div className=" h-full px-3 pb-4 overflow-y-auto dark:bg-gray-800">
                <ul className="space-y-2 font-medium fixed ">
                    <li>
                        <Link to={"dashboard"} id="dashboard" href="#" className={`flex w-44 transition-colors duration-300 items-center px-2 py-1.5 text-gray-200 rounded-lg dark:text-white group ${page == "dashboard" ? 'dark:bg-gray-700 bg-gray-300 text-gray-900' : 'hover:bg-gray-300 hover:text-gray-900 dark:hover:bg-gray-700'} `}>
                    ...
                    <li>
                        <Link to={"hiring"} id="hiring" href="#" className={`flex transition-colors duration-300 items-center px-2 py-1.5 text-gray-200 rounded-lg dark:text-white group ${page == "hiring" ? 'dark:bg-gray-700 bg-gray-300 text-gray-900' : 'hover:bg-gray-300 hover:text-gray-900 dark:hover:bg-gray-700'} `}>
