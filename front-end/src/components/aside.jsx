...
export default function Aside() {
    ...
    return (
        <Asside id="logo-sidebar" className={`fixed bg-gray-700 shadow-2xl top-6 z-10 w-52 h-screen pt-20 transition-transform -translate-x-full bg-white  sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700`} aria-label="Sidebar">
