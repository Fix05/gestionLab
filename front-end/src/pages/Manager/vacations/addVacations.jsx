...
export default function AddVacations() {
    ...
    const SUCCESSFULLY_ADDING = 'Ausencia laboral registrada'

    return (
        <Adding apiEndpoint={ENDPOINT} ModalComponent={AddVacationModal} bgcolor={"bg-red-200"} dataMapping={ExtraMapping} addingDoneMessage={SUCCESSFULLY_ADDING}/>
    )
}