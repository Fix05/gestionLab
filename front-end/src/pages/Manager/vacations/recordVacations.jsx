...
import MonthPickerViews from '../../../components/monthPicker'
...
export default function RecordVacations() {
    ...
    const { changedList, setChangedList, originalValues,
        setOriginalValues, message, setMessage } = useTransformData(listResult, VacationsMapping, ELEMENTS_PER_PAGE)
    ...
    return (
        <div className="mt-6 rounded-lg border-2 border-gray-400 bg-white">
            ...
            {console.log("Keys", Object.keys(changedList[0]).length > 0)}
