...
export default function MainPage() {
    ...
    return (
        <>
            <article className="bg-opacity-95 max-h-72 bg-gray-100 mx-5 mt-16 w-full rounded-lg border border-gray-100 p-4 shadow-sm transition hover:shadow-2xl hover:bg-opacity-100 sm:p-6">
            ...
            <article className="bg-opacity-95 max-h-72 bg-gray-100 mx-5 w-full mt-16 rounded-lg border border-gray-100 p-4 shadow-sm transition hover:shadow-2xl hover:bg-opacity-100 sm:p-6">
                <span className="inline-block rounded bg-blue-600 p-2 text-white">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6"
